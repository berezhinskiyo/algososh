...
describe('Стек', () => {
    it('Проверьте, что если в инпуте пусто, то кнопка добавления недоступна', () => {
        ...
        cy.visit(`${Cypress.env('base_url')}${Cypress.env('stack')}`);
    ...
    it('Проверьте правильность добавления элемента в стек', () => {
        ...
        cy.get('.circle_head__E38zo').eq(0).contains('top');
        ...
        cy.get('.circle_head__E38zo').eq(1).contains('top');
    ...
    it('Проверить правильность удаления элемента из стека', () => {
        ...
        cy.get('.text_type_circle').should('have.length', 1)
    ...
    it('Проверьте поведение кнопки «Очистить»', () => {
        ...
        cy.tick(1000);
        cy.get('.text_type_circle').should('have.length', 0)
